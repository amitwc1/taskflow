...
export default function SignupPage() {
  const { signUp, signInWithGoogle, loading, error, clearError, user, initialized } = useAuthStore();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary/10 to-secondary/10 p-4">
      <div className="w-full max-w-md bg-background rounded-xl shadow-xl border border-border p-8">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-2.5 bg-surface hover:bg-surface-hover text-foreground rounded-lg font-medium transition-colors border border-border flex items-center justify-center gap-2"
        >
